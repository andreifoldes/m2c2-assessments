    ...
    extraSections: [
      {
        ...
        body: [
          ...
          "",
          "80 neutral-expression targets with a rated age of 18–40 were selected using the CFD's published norming data and organized into 4 fixed lists of 20 face–name pairs. Lists are exactly matched on race (5 each of Asian, Black, Latino/a, and White targets per list) and gender (10 male / 10 female per list), and equated on rated age and attractiveness — see *List balance* below. Each face is paired with a gender-matched England and Wales first name selected by 20-year historical popularity (ONS baby-name ranks); within a list, all names differ by a Levenshtein distance of at least 3 to keep typed responses discriminable. See *Names* below.",
          "",
      ...
      },
      {
        title: "Names",
        body: [
          "Each list has 10 male and 10 female names, gender-matched to the faces. Names come from the ONS England and Wales baby-name ranks, selected by 20-year historical popularity (mean annual rank over the most recent 20 published years). A snake-deal would leave lists comparable only in pooled mean rank — one gender could offset the other — so after the Levenshtein repair the build script hill-climbs with **within-gender swaps** until male-name popularity is equated across lists and female-name popularity is equated across lists. The section below is extracted verbatim from the committed [`tools/stimulus_report.md`](https://github.com/andreifoldes/m2c2-assessments/blob/main/assessments/fname-pairs/tools/stimulus_report.md), so the names and numbers always reflect the deployed `lists.json`.",
        ].join("\n"),
        includeFile: {
          file: "assessments/fname-pairs/tools/stimulus_report.md",
          heading: "Names",
