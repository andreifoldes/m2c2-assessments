...
export async function initWebGazer() {
  ...
  // Using v2.1.2 because it bundles TFjs face tracking internally.
  // v3.x requires external MediaPipe wasm/js files that it loads via
  // internal script injection, which cannot be reliably redirected to CDN.
