import { Game, WebColors, RandomDraws, Sprite, Scene, Transition, Easings, TransitionDirection, M2Error as M2Error$1, Shape, Label, Timer, Action } from '@m2c2kit/core';
...
class SymbolSearch extends Game {
  constructor() {
    ...
    const options = {
      ...
      moduleMetadata: { "name": "@m2c2kit/assessment-symbol-search", "version": "0.8.32", "dependencies": { "@m2c2kit/addons": "0.3.33", "@m2c2kit/core": "0.3.34", "@m2c2kit/data-calc": "0.8.5" } },
      translation,
  ...
  calculateScores(data, extras) {
    ...
    const scores = dc.summarize({
      ...
      participant_score: (obs) => obs.median_response_time_correct === null ? null : 1e4 / obs.median_response_time_correct
    });
