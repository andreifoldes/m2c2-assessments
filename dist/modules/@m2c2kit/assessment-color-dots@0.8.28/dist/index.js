import { Game, WebColors, Sprite, Scene, M2Error, Transition, RandomDraws, Shape, Label, Action, Timer, LabelHorizontalAlignmentMode, Equal, Easings, TransitionDirection } from '@m2c2kit/core';
...
class ColorDots extends Game {
  constructor() {
    ...
    const options = {
      ...
      moduleMetadata: { "name": "@m2c2kit/assessment-color-dots", "version": "0.8.28", "dependencies": { "@m2c2kit/addons": "0.3.29", "@m2c2kit/core": "0.3.30" } },
      translation,
