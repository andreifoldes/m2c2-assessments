...
options?: SummarizeOptions) => DataValue;
 ...
 */
declare class SummarizeOperation {
    private leafFn?;
    parameters?: DataValue[] | undefined;
    options?: SummarizeOptions;
    private tokens;
    summarizeFunction: SummarizeFunction;
    constructor(leafFn?: SummarizeFunction, parameters?: DataValue[] | undefined, options?: SummarizeOptions, tokens?: Token[]);
    static leaf(leafFn: SummarizeFunction, parameters?: DataValue[] | undefined, options?: SummarizeOptions): SummarizeOperation;
    private cloneWithTokens;
    private appendOp;
    /**
     ...
     * ```
     */
    add(x: number | SummarizeOperation): SummarizeOperation;
    /**
     ...
     * ```
     */
    sub(x: number | SummarizeOperation): SummarizeOperation;
    /**
     ...
     * ```
     */
    mul(x: number | SummarizeOperation): SummarizeOperation;
    /**
     ...
     * ```
     */
    div(x: number | SummarizeOperation): SummarizeOperation;
    /**
     ...
     * ```
     */
    pow(x: number | SummarizeOperation): SummarizeOperation;
    private evaluateOperandToNumber;
    private evaluateFlatTokens;
    /**
 ...
 * ```
 */
declare function parens(op: SummarizeOperation): SummarizeOperation;
 ...
 * ```
 */
declare function scalar(value: number | boolean | null | undefined): SummarizeOperation;
declare const s: typeof scalar;

export { DataCalc, SummarizeOperation, max, mean, median, min, n, parens, s, scalar, sd, sum, variance };
export type { DataCalcOptions, DataValue, Mutations, Observation, SummarizeFunction, SummarizeOptions };
